...
- **最终实测**：439 个 Java 类、2442 处字面量替换；成品镜像 477 个资源含中文、共 20473 个中文字符；残留英文均为有意保留项（SQL/协议日志/专名）
...
- **确定性可复现**：同一原始镜像 + 同一字典，命令行与双击入口产物 SHA256 完全一致
...
- 打包 `Sparrow-2.5.4-中文便携版.zip`（261,735,839 字节，SHA256 `ADD44DE35D5FFBB62F011CE27D489551969FF68D88560922C2E21C24566F3713`）
...
### 交付物
- 汉化镜像 `中文补丁\patch\modules.patched`（89,890,763 字节，SHA256 `22FD4DCF9115749297D8D55BE4B76DB13B33B172C42C08DFFA33B7B47FFDE376`）
...
- 一键构建/应用/还原脚本、翻译字典（FXML + Java 六批，合并字典 2330 条以 .gz 存放于仓库）
